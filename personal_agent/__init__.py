...
from personal_agent.github import GitHubClient, GitHubError, PullRequest
...
__all__ = [
    ...
    "FileChange", "FunctionWorker", "GitHubClient", "GitHubError", "PullRequest",
    "SecretRedactor", "SecurityError", "Synthesis", "Task", "TaskResult", "VerificationConfig",
    "VerificationEvidence", "Work", "Worker", "WorkerResult", "create_router",
    "evaluate_hard_gates", "redact_secrets", "resolve_in_workspace", "sanitize_worker_environ",
]
